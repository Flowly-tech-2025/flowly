...
function criarBannerCookies() {
    ...
    banner.innerHTML = `
        <div class="cookie-content">
            <p>Utilizamos cookies para melhorar sua experiência em nosso site. Ao continuar navegando, você concorda com nossa <a href="privacidade.html" style="color: #ff3e3e; text-decoration: underline;">Política de Privacidade</a>.</p>
        </div>
